...
public class FragmentRms extends Fragment implements FragmentDothi.PhantichDothi {
    private View layout;
    ListView lvToado;
    ...
    public void guiGiatriphantich(int position, Float giatri1, Float giatri2, Float giatri3) {
        ...
        if (dulieuDothiList.get(position).getTencambien() == "Vị trí") {
            txtGiatri1.setText("RMS=" + df1.format(giatri1).replace(',', '.') + " " + donvi);
            txtGiatri2.setText("Peak=" + df1.format(giatri2).replace(',', '.') + " " + donvi);
        } else if (dulieuDothiList.get(position).getTencambien() == "Dòng điện") {
            txtGiatri1.setText("RMS=" + df3.format(giatri1).replace(',', '.') + " " + donvi);
            txtGiatri2.setText("Peak=" + df3.format(giatri2).replace(',', '.') + " " + donvi);
        } else {
            txtGiatri1.setText("RMS=" + df2.format(giatri1).replace(',', '.') + " " + donvi);
            txtGiatri2.setText("Peak=" + df2.format(giatri2).replace(',', '.') + " " + donvi);
        }
