...
public class chonsodoAdapter extends BaseAdapter {
    ...
    private int layout;
    private List<SodoCambien> sodoList;

    public chonsodoAdapter(Context context, int layout, List<SodoCambien> sodoList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        SodoCambien thietbi = sodoList.get(i);
        viewHolder.txtMacambien.setText(thietbi.getBleDevice().getName());
